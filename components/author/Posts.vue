...
<template>
  ...
  <section id='post'
    class="sm:grid grid-cols-1 mx-0 gap-4 justify-items-center relative sm:grid-cols-2 sm:mx-5 lg:grid-cols-3 lg:mx-10 overflow-hidden mb-20 max-sm:min-h-[1500px]">
