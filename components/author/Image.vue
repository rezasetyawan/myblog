    ...
    <div class="border-2 rounded-lg p-1 my-2 w-full flex justify-between">
        <div class="">
            <NuxtImg :src="props.image.url"
                class="object-cover brightness-90 group-hover:brightness-100 transition-all rounded-sm aspect-[4/2]"
            ...
            <div>
                ...
                <div class="flex flex-col gap-1 items-start justify-center font-medium text-sm ">
                    ...
                    <label class="group relative">
                        ...
                        <input :value="image.url" readonly class="p-1 max-w-[80%] focus:outline-none"
                            :id="image.id + '_url'">
