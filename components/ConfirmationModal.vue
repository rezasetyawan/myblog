...
<template>
    <section v-if="props.showConfirmationModal">
        <div tabindex="-1"
            ...
            @click="closeModal">
            <div class="relative w-full max-w-sm max-h-full mx-auto z-[3001]"
                :class="{ open: props.showConfirmationModal, close: !props.showConfirmationModal }">
                <div class="relative bg-white rounded-lg shadow">
                    <button type="button"
                        class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                        @click="closeModal">
                        <svg class="w-5 h-5 text-[#656161]" fill="currentColor" viewBox="0 0 20 20"
                    ...
                    <div class="p-6 text-center">
                        <svg aria-hidden="true" class="mx-auto my-4 text-[#656161] w-14 h-14 animate-pulse" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" fill=""
