...
<template>
  <section v-if="props.blog" class="my-10 mx-3 mb-20 sm:mx-6 lg:mx-40">
    <button class="absolute -top-8 left-1 sm:top-0 sm:left-5" @click="() => useRouter().go(-1)">
    ...
    <div class="my-3">
      ...
      <div class="flex justify-center py-4">
        <NuxtImg :src="props.blog.image_url" class="max-w-sm aspect-[4/2] object-cover overflow-hidden sm:max-w-2xl"
          loading="lazy" quality="50" placeholder :alt="props.blog.title" />
      </div>
